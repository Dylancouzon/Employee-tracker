            ...
            .then((response) => {
                connection.query(`SELECT id FROM employee WHERE ? AND ?`,
                    ...
                    (err, res) => {
                        if (err) throw err;
                        if (res.length != 0) {
                            employeesManagerCB(res[0].id, response.firstName, response.lastName);
                        } else {
    ...
    viewEmployeesDepartment() {
        ...
        connection.query(`SELECT * FROM department`,
            (err, res) => {
                ...
                generateDepartment(departments);
        ...
        connection.query(`SELECT * FROM department`,
            (err, res) => {
                ...
                if (res.length != 0) {
                    ...
                    setTimeout(function () { console.table(dptData); }, 500);
...
function generateDepartment(departments) {
